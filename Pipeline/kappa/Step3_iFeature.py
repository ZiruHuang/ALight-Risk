...
fea_extr('2.Training_Data/Kappa/Kappa_trainset-1.fasta','3.iFeature/Kappa/subModel_1')
fea_extr('2.Training_Data/Kappa/Kappa_test_88.fasta','3.iFeature/Kappa/test/')
fea_extr('2.Training_Data/Kappa/Kappa_trainset-1.fasta','3.iFeature/Kappa/All_traning_data/')

merge_label_matrix('3.iFeature/Kappa/subModel_1/','2.Training_Data/Kappa/Kappa_trainset-1_label.txt')
merge_label_matrix('3.iFeature/Kappa/test/','2.Training_Data/Kappa/Kappa_test_88_label.txt')
merge_label_matrix('3.iFeature/Kappa/All_traning_data/','2.Training_Data/Kappa/Kappa_trainset-1_label.txt')